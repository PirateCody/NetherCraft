...
public class NCBlocks {
	...
	public static Block oreEbony = new BlockNC("EbonyOre", Material.rock, 5.0F, 15.0F, 0F, "pickaxe", 3);
	public static Block oreCorruptObsidian = new BlockNC("CorruptObsidianOre", Material.rock, 5.0F, 25.0F, 0F, "pickaxe", 3);
	public static Block oreCorruptEbony = new BlockNC("CorruptEbonyOre", Material.rock, 5.0F, 20.0F, 0F, "pickaxe", 3);
	...
	public static void registerBlocks(){
		...
		RegisterHelper.registerBlock(oreCorruptObsidian);
		RegisterHelper.registerBlock(oreCorruptEbony);
